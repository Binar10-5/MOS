...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; text-align: center; font-family: Roboto, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;"><strong style="font-family: inherit;">Te informamos que el pago para tu pedido <span style="color: #ffffff; background-color: #000000;"> {{$data['numeral']}}{{$data['order_number']}} </span> ha sido aprobado exitosamente. Pronto te estaremos informando cuando sea despachado.</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
